...
exports.default = _vue2.default.component("Migration", {
    ...
    methods: {
        migrate: function migrate(direction) {
...
new _vue2.default({
    ...
    data: { baseUrl: baseUrl, migrations: migrations },

    methods: {
        shouldDisable: function shouldDisable(direction, migration) {
        ...
        migrate: function migrate(direction, componentPath) {
            this.$http.post(this.baseUrl + "cbmigrations/" + direction, { componentPath: componentPath }).then(function (response) {
                console.log("success", response);
            }, function (err) {
                console.error("error", err);
            });
...
},{"./Migration":4,"vue":3,"vue-resource":2}]},{},[5]);
